...
while True:
    ...
    if bdistopbot>55 and adistopbot>55 and abs(adistopbot-bdistopbot)<10 and abs(acountimg-bcountimg)<30:
        data = unity_api.set_speed_angle(20, 0)
        print(' ahead 3\n')
        continue
    # elif  bdistopbot<54 and adistopleft <250 and acountimg>220:
    #     data = unity_api.set_speed_angle(10, -15)
    #     print(' ngatu 3\n')
    #     continue
    elif bdistopleft ==0 and adistopleft>285 and adistopbot >65 and acountimg>295:
        ata = unity_api.set_speed_angle(15, -4)
        print(' right 3\n')
        continue
    elif adistopleft ==0 and bdistopleft>285 and bdistopbot >65 and bcountimg>295:
        ata = unity_api.set_speed_angle(15, 4)
        print(' left 3\n')
        continue
    elif bcountimg <=200 and acountimg >=280:
        data = unity_api.set_speed_angle(15, -25)
        print('turn left\n')
        continue
        ...
        print('turn right\n')
        continue
    ang=(angleft.real+angright.real)
